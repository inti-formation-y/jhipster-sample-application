...
/**
 * REST controller for managing {@link fr.formation.inti.domain.Eleve}.
 */
@RestController
@RequestMapping("/api")
public class EleveResource {
     ...
     */
    @GetMapping("/eleves")
    public ResponseEntity<List<Eleve>> getAllEleves(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
